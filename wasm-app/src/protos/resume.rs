...
pub struct Resume {
    ...
    pub about_me: ::std::string::String,
...
impl Resume {
    ...
    // Param is passed by value, moved
    pub fn set_about_me(&mut self, v: ::std::string::String) {
        self.about_me = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_about_me(&mut self) -> &mut ::std::string::String {
        &mut self.about_me
    }

    // Take field
    pub fn take_about_me(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.about_me, ::std::string::String::new())
    }
...
impl ::protobuf::Message for Resume {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.about_me)?;
                },
                10 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.about_me.is_empty() {
            my_size += ::protobuf::rt::string_size(9, &self.about_me);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.about_me.is_empty() {
            os.write_string(9, &self.about_me)?;
        }
        for v in &self.education {
...
impl Education {
    ...
    pub fn clear_degree(&mut self) {
        self.degree = Education_Degree::BACHELORS;
    }
...
impl ::protobuf::Message for Education {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.degree != Education_Degree::BACHELORS {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cresume.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb4\x03\n\
    ...
    \n\x0egithub_profile\x18\x08\x20\x01(\tR\rgithubProfile\x12\x19\n\x08abo\
    ut_me\x18\t\x20\x01(\tR\x07aboutMe\x12(\n\teducation\x18\n\x20\x03(\x0b2\
    \n.EducationR\teducation\x12+\n\nexperience\x18\x0b\x20\x03(\x0b2\x0b.Ex\
    perienceR\nexperience\x12&\n\x06skills\x18\x0c\x20\x03(\x0b2\x0e.SkillCa\
    tegoryR\x06skills\"H\n\x0bPhoneNumber\x12!\n\x0ccountry_code\x18\x01\x20\
    \x01(\rR\x0bcountryCode\x12\x16\n\x06number\x18\x02\x20\x01(\x04R\x06num\
    ber\"N\n\x08Location\x12\x12\n\x04city\x18\x01\x20\x01(\tR\x04city\x12\
