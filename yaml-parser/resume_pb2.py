...
Duty = _reflection.GeneratedProtocolMessageType('Duty', (_message.Message,), dict(
  DESCRIPTOR = _DUTY,
  __module__ = 'resume_pb2'
...
SkillCategory = _reflection.GeneratedProtocolMessageType('SkillCategory', (_message.Message,), dict(
